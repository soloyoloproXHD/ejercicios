...
export interface ApiClaseClase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detalles_adicionales: Schema.Attribute.Component<
      'escuela.detalles-adicionales-clase',
      true
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::clase.clase'> &
      Schema.Attribute.Private;
    profesores: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    material_de_estudio: Schema.Attribute.Component<'escuela.material', true>;
    profesores: Schema.Attribute.Relation<
      'manyToMany',
      'api::profesor.profesor'
    >;
    publishedAt: Schema.Attribute.DateTime;
    temario: Schema.Attribute.Component<'escuela.tema', true>;
    titulo: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zona_dinamica: Schema.Attribute.DynamicZone<
      [
